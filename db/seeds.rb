...
#PRODUCTS SEED
Product.create!(name: "Crash", price: 15, description: "Beautiful cat pet rock", quantity: 100, supplier_id: 3)
Product.create!(name: "Ladybug", price: 15, description: "A beautiful ladybug pet rock", quantity: 75, supplier_id: 3)
Product.create!(name: "Unicorn", price: 25, description: "A beautiful unicorn pet rock", quantity: 50, supplier_id: 3)
Product.create!(name: "Person", price: 9, description: "A person pet rock", quantity: 110, supplier_id: 4)
Product.create!(name: "Valentine", price: 20, description: "A valetine's themed pet rock", quantity: 25, supplier_id: 4)
Product.create!(name: "Flower", price: 10, description: "A beautiful flower pet rock", quantity: 100, supplier_id: 4)

#SUPPLIERS SEED
Supplier.create!(name: "Pet Rock Original", email: "petrock@email.com", phone: "1234567809")
Supplier.create!(name: "Pet Rock Competitor", email: "competitor@email.com", phone: "9087654321")
Supplier.create!(name: "Pebbles Inc.", email: "pebbles@email.com", phone: "4657372845")
...
Image.create!(url: "https://i.pinimg.com/236x/69/a2/e0/69a2e0ad4d4d87f541002402d7facccb--owl-rocks-rock-animals.jpg", product_id: 2)
...
#USERS SEED
User.create!(name: "Jeanna", email: "jeanna@test.com", password: "password", admin: true)
User.create!(name: "Alex", email: "alex@test.com", password: "password", admin: false)
...
#CATEGORY_PRODUCT SEED (join table for has many / has many relationship)
...
#CARTED_PRODUCT SEED (join table for user, product, and order!)
CartedProduct.create!(user_id: 1, product_id: 1, quantity: 6, status: "carted", order_id: nil)
CartedProduct.create!(user_id: 1, product_id: 2, quantity: 12, status: "carted", order_id: nil)
CartedProduct.create!(user_id: 1, product_id: 3, quantity: 8, status: "carted", order_id: nil)
CartedProduct.create!(user_id: 2, product_id: 4, quantity: 1, status: "carted", order_id: nil)
CartedProduct.create!(user_id: 2, product_id: 5, quantity: 21, status: "carted", order_id: nil)
